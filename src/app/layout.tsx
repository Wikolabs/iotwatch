...
export const metadata: Metadata = { title:"IoTWatch — Monitoring IoT industriel temps reel", description:"Collecte, analyse et alertes temps reel pour parcs IoT industriels. MQTT, LoRaWAN, Modbus. 10 000 capteurs. Zero alerte manquee." };
